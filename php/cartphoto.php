...
require_once ("CreateDbphoto.php");
require_once ("componentphoto.php");

$db = new CreateDbphoto("art", "Producttbphoto");
    ...
    if ($_GET['action'] == 'remove'){
        foreach ($_SESSION['cart'] as $key => $value){
            if($value["product_id"] == $_GET['id']){
                ...
                echo "<script>window.location = 'cartphoto.php'</script>";
            }
        }
    }
}
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="dropdown">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        <a href="../alligraphy.php" target="_blank">Calligraphy</a>
...
<div class="row price-details">
    ...
    <a href="billcartphoto.php" type="submit" class="btn  rebtn btn-danger mt-5" name="checkout">checkout</a>
