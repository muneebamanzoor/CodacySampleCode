...
require_once ("CreateDbabstract.php");
require_once ("componentabstract.php");

$db = new CreateDbabstract("art", "Producttbabstract");
    ...
    if ($_GET['action'] == 'remove'){
        foreach ($_SESSION['cart'] as $key => $value){
            if($value["product_id"] == $_GET['id']){
                ...
                echo "<script>window.location = 'cartabstract.php'</script>";
            }
        }
    }
}
        ...
        <div class="col-md-4 offset-md-1 border rounded mt-5 bg-white h-25">
            ...
            <div class="pt-4">
                ...
                <div class="row price-details">
                    ...
                    <a href="billcartabstract.php" type="submit" class="btn  rebtn btn-danger mt-5" name="checkout">checkout</a>
