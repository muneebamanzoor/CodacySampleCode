...
require_once ("CreateDbpaint.php");
require_once ("componentpaint.php");

$db = new CreateDbpaint("art", "Producttbpaint");
    ...
    if ($_GET['action'] == 'remove'){
        foreach ($_SESSION['cart'] as $key => $value){
            if($value["product_id"] == $_GET['id']){
                ...
                echo "<script>window.location = 'cartpaint.php'</script>";
            }
        }
    }
}
...
<head>
    <meta charset="utf-8" />
    <title>Shopping Paintings</title>
