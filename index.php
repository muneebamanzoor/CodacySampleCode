        ...
        .social-circle li i {
           ...
           text-align: center;
               ...
               body {
                   width: 100%;
                   height: 100%;
                   background-image: url("https://c0.wallpaperflare.com/preview/418/179/621/green-blue-and-orange-paint-splat-artwork.jpg");
...
<body>
    ...
    <div class="getstar">
        <img src="images/get.png" style="background-color:aliceblue;"/><br />
        <p>
            <h3 style="color:aliceblue">&nbsp; Art is never finished, only abandoned.</h3>
        </p>
    </div>
    <a href="introduction.php" target="_blank" class="check2" role="button" aria-pressed="true">GET STARTED</a>
