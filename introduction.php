...
<head>
    <meta charset="utf-8" />
    <title>Introduction - Artistera</title>
...
<section id="nav-bar">
    ...
    <div class="calligraphy">
        ...
        <h1 class="calligraphytext">Welcome To Artistera</h1>
    </div>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://www.arabic-calligraphy.com/wp-content/uploads/2018/09/calligraphy.png" height="400" width="600" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item">
                <img src="https://i1.wp.com/doodlewash.com/wp-content/uploads/2019/05/January-Storm-1000w.jpg?fit=1000%2C581&ssl=1" height="400" width="600" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <strong><h1 style="color: black; text-align:right; font-weight:bolder; font-family: Papyrus">Abstract Art</h1></strong>
                </div>
            </div>
            <div class="carousel-item">
                <img src="https://previews.123rf.com/images/olegdudko/olegdudko1908/olegdudko190803400/128880447-row-of-artist-paint-brushes-on-background.jpg" height="400" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block" >
                    <strong><h1 style="color: darkslategray;  text-align:left; font-weight:bolder; font-family: Papyrus; ">Paintings</h1></strong>    
                </div>
            </div>
            <div class="carousel-item">
                <img src="https://cdn.mos.cms.futurecdn.net/gvQ9NhQP8wbbM32jXy4V3j.jpg" height="400" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <strong><h1 style="color: bisque;  text-align:right; font-weight:bolder; font-family: Papyrus;">Photography</h1></strong>          
                </div>
            </div>
            <div class="carousel-item">
                <img src="https://webneel.com/daily/sites/default/files/images/daily/08-2020/23-modeled-sculpture-selena-wax-madame.jpg" height="400" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
    ...
    <div class="row text-center">
        <div class="col-xs=12 col-sm-12 col-md-12 col-lg-12">
            ...
            <hr />
                <div class="header1">
                    <div class="about">
                    <h1 style="color: white ; line-height:initial;  font-family:Rockwell; margin-top: 20px;"> Art - An Introduction</h1>
                </div>
                    <hr />
<div id="divcontainer">
    <div class="d-inline-block" id="contentcolumn">
        <div class="innertext" style="font-family: 'Comic Sans MS';;">
            <br> Art is a diverse range of (and products of) human activities involving creative imagination to express technical proficiency, beauty, emotional power, or conceptual ideas.
            There is no generally agreed definition of what constitutes art, and ideas have changed over time. The three classical branches of visual art are painting, sculpture, and architecture. Theatre, dance, and other performing arts, as well as literature, music, film and other media such as interactive media, are included in a broader definition of the arts.[1][8] Until the 17th century, art referred to any skill or mastery and was not differentiated from crafts or sciences. In modern usage after the 17th century, where aesthetic considerations are paramount, the fine arts are separated and distinguished from acquired skills in general, such as the decorative or applied arts.
